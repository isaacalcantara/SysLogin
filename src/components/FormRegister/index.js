        ...
        <div className="wrap-register">
            <form className="register-form">
              ...
              <div class='select-box'>
                <select class='select'>
                  <option value="" key="" class='option'>Active</option>
                  <option value="" key="" class='option'>Freeze</option>
                </select>

                <select class='select'>
                  <option value="" key="" class='option'>Standart</option>
                  <option value="" key="" class='option'>Admin</option>
                </select>
              </div>
